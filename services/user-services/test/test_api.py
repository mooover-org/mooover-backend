...
class TestApi:
    ...
    def setup(self):
        ...
        self.user1 = {"sub": "1", "name": "test", "given_name": "test",
                      "family_name": "test", "nickname": "test",
                      "email": "test@test.test", "picture": "test"}
        self.user2 = {"sub": "2", "name": "test", "given_name": "test",
                      "family_name": "test", "nickname": "test",
                      "email": "test@test.test", "picture": "test"}
    ...
    def test_get_user(self):
        ...
        for key, value in self.user1.items():
    ...
    def test_add_user(self):
        ...
        response_json = response.json()
        for key, value in self.user2.items():
            assert response_json[key] == value
        response = self.client.post(
            "/api/v1/users",
            json=self.user2,
